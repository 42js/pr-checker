...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var token, currectLabel_1, wrongLabel_1, configPath, prNumber, client, config, pr, changedFiles, subjects, removeLabels, _loop_1, _i, _a, _b, key, subject_1, subject, _c, _d, label, error_1;
        ...
        switch (_e.label) {
            ...
            case 12:
                ...
                for (_c = 0, _d = Object.values(REASON); _c < _d.length; _c++) {
                    label = _d[_c];
                    if (pr.labels.find(function (label) { return label.name === label; })) {
