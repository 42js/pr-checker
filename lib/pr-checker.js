...
exports.addLabels = exports.removeLabel = exports.addComment = exports.getPrNumber = exports.getContent = exports.getConfig = exports.isTeamMember = exports.getChnageFiles = exports.isMatch = exports.closePR = exports.wrongSubmission = exports.run = exports.toLocalString = void 0;
...
// @ts-ignore
var ko_1 = __importDefault(require("date-and-time/locale/ko"));
...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var token, currectLabel_1, wrongLabel_1, configPath, prNumber, client, config, pr, changedFiles, subjects, removeLabels, _loop_1, _i, _a, _b, key, subject_1, subject, _loop_2, _c, _d, reason, error_1;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                wrongLabel_1 = core.getInput("wrong-label", { required: true });
            ...
            case 3:
                ...
                return [4 /*yield*/, exports.wrongSubmission(client, prNumber, [wrongLabel_1, REASON.WRONG_PATH], removeLabels, [
            ...
            case 5:
                ...
                return [4 /*yield*/, exports.wrongSubmission(client, prNumber, [wrongLabel_1, REASON.TOO_MANY_SUBMISSIONS], removeLabels, [
                        !!pr.user && "\uD83D\uDC4B \uC548\uB155\uD558\uC138\uC694! " + pr.user.login + "\uB2D8!",
            ...
            case 6:
                ...
                return [2 /*return*/];
            case 7: return [4 /*yield*/, exports.addLabels(client, prNumber, [subjects[0]])];
            case 8:
                _e.sent();
            ...
            case 12:
                ...
                _loop_2 = function (reason) {
                    if (pr.labels.find(function (label) { return label.name === reason; })) {
                        exports.removeLabel(client, prNumber, reason);
                    }
                };
                for (_c = 0, _d = Object.values(REASON); _c < _d.length; _c++) {
                    reason = _d[_c];
                    _loop_2(reason);
                }
                return [4 /*yield*/, exports.addLabels(client, prNumber, [currectLabel_1])];
            case 13:
                _e.sent();
